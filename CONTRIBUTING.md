...
[issues do GitHub](https://github.com/grintex/template/issues). Porém antes
...
[criar uma nova issue](https://github.com/grintex/template/issues/new). No
...
2. Também verifique se a ideia já não está pressente em nossas
   [issues do GitHub](https://github.com/grintex/template/issues);
...
[criar uma nova issue](https://github.com/grintex/template/issues/new)
...
Para criar seu pedido de funcionalidade [criar uma nova issue](https://github.com/grintex/template/issues/new) usando
o label **feature**.
