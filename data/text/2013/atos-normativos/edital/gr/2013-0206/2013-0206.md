 ...
 **9.2** Havendo situações de empate após a análise, o desempate entre os(as) candidatos(as) será determinado de acordo com a seguinte ordem de critérios, considerando os índices de classificação:
